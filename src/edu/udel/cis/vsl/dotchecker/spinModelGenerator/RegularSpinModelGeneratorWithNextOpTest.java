...
public class RegularSpinModelGeneratorWithNextOpTest {
	public static void main(String[] args) throws IOException {
		String problemNum = "115";
		...
		RegularSpinModelGeneratorWithNextOp generator = new RegularSpinModelGeneratorWithNextOp(
				out);
