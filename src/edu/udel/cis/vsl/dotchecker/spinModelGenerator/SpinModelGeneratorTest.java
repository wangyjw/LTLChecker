...
public class SpinModelGeneratorTest {
	public static void main(String[] args) throws IOException {
		...
		String spinPropertiesPath = "examples/2017Spin/spin" + problemNum
				+ "-properties.txt";
		String spinReductionModelFilePathDir = "examples/2017SpinReductionModel/problem"
				+ problemNum + "/";
		...
		SpinModelGenerator generator = new SpinModelGenerator(out);
